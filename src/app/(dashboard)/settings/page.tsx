...
import { Save, Building2, Clock, Calendar, DollarSign, Bell, Sliders, Stethoscope, Tag } from 'lucide-react'
import ServicesPanel from '@/components/settings/ServicesPanel'
import ServicePricingPanel from '@/components/settings/ServicePricingPanel'
...
type Section = 'clinic' | 'hours' | 'appointments' | 'billing' | 'reminders' | 'system' | 'services' | 'service_pricing'
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {active !== 'service_pricing' && active !== 'services' && (
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 card space-y-6">
          ...
          {/* Service Pricing */}
          {active === 'service_pricing' && <ServicePricingPanel />}
